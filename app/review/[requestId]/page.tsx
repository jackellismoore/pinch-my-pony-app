  ...
  return (
    <div className="pmp-pageShell pmp-reviewPage">
      ...
      <section className="pmp-reviewHero">
        <div className="pmp-reviewCompletion"><span>✓</span><div><strong>Booking complete</strong><small>Ready for your feedback</small></div></div>
