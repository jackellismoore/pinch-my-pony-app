    ...
    return (
      <Link
        ...
        style={{
          ...
          background: active ? "rgba(31,61,43,0.10)" : "rgba(255,255,255,0.70)",
          border: active ? "1px solid rgba(31,61,43,0.24)" : "1px solid rgba(31,42,68,0.12)",
    ...
    <div style={{ minHeight: "100vh", background: pageBg }}>
      <style>{`
        ...
        @media (max-width: 980px) {
          ...
          .pmp-owner-aside { position: relative !important; top: auto !important; }
        }
      `}</style>
      ...
      >
        ...
        >
          {/* This wrapper gives the “nice page container” feel WITHOUT double-boxing */}
