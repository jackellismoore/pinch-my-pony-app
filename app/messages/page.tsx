    ...
    return (
      <div style={{ padding: 20 }}>
        ...
        <div style={{ opacity: 0.7, marginBottom: 12 }}>
          This page must be opened as <code>/messages/&lt;requestId&gt;</code>
        </div>
    ...
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", background: "#f6f7fb" }}>
      ...
      >
        ...
        <div style={{ marginLeft: "auto" }}>
          <Link href="/messages" style={{ fontSize: 12, color: "#2563eb", fontWeight: 900, textDecoration: "none" }}>
            Back
          </Link>
        </div>
      </div>
