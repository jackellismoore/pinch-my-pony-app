...
export default function ProfilePage() {
  ...
  async function tryUpdate(payload: Record<string, any>) {
    ...
    if (!looksLikeMissingColumn) return { ok: false as const, warn: null as string | null, error: attempt1.error };
    ...
    if (attempt2.error) return { ok: false as const, warn: null as string | null, error: attempt2.error };
    ...
    <div style={{ padding: 16, maxWidth: 900, margin: '0 auto' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12 }}>
          <div style={{ fontSize: 12, color: 'rgba(0,0,0,0.55)' }}>
            Profile ID: <span style={{ fontFamily: 'ui-monospace, SFMono-Regular, Menlo, monospace' }}>{userId}</span>
          </div>
